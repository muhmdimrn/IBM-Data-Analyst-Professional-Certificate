...
-- For each department retrieve the number of employees in the department, and the 
-- average employee salary in the department.
SELECT DEP_ID, COUNT(*), AVG(SALARY)
FROM EMPLOYEES
GROUP BY DEP_ID;

-- Label the computed columns in the result set of SQL problem 2 (Exercise 3 Problem 2) 
