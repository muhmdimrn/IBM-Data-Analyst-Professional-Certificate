...
-- Re-write the previous query but have the result set include all the employees but department 
...
-- Re-write the previous query but have the result set include all employee names but department 
